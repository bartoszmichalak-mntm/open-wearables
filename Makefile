...
init:  ## Seed sample data. Use 'make init users=5' to specify number of users (default: 10)
	...
	$(DOCKER_EXEC) uv run python scripts/init/seed_activity_data.py --users $(or $(users),10)
